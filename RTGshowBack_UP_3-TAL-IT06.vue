                ...
                <v-col cols="12" class="ma-0 pa-0" style="margin: 0 auto">
                  <v-row style="padding: 0 !important" class="equipmentInRow">
                    <v-col
                      ...
                      v-if="allBothAddButton_switch"
                      cols="1"
                      style="position: relative; max-width: 70px"
                    >
                      <span class="switchEquipmentIn"> NI </span>
                    </v-col>
                    <v-col
                    ...
                    >
                      ...
                      >
                        <v-col
                          ...
                          @mouseleave="removeEquipmentEditCheckedForSwitchWith(item)"
                          :disabled="true"
                  ...
                  <v-row class="equipmentOutRow">
                    ...
                    >
                      <span
                        ...
                        style="
                          transform: scaley(2.5) skewY(21deg) rotateY(-180deg) !important;
                        "
                      >
                        TUO
                      </span>
...
export default {
  ...
  methods: {
    ...
    removeEquipmentEditCheckedForSwitchWith(item) {
      this.equipmentEditCheckedForSwitchWith = item;
      return item;
    },
