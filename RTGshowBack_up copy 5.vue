                  ...
                  <v-row style="padding: 0 !important" class="equipmentInRow">
                    ...
                    >
                      <span
                        ...
                        style="
                          transform: scaleY(1.5) skewY(21deg) rotateY(-180deg)
                            translateY(47%) translateX(20%) !important;
                        "
                      >
                        NI
                      </span>
                  ...
                  <v-row class="equipmentOutRow">
                    ...
                    >
                      <span
                        ...
                        style="
                          transform: scaleY(1.5) skewY(21deg) rotateY(-180deg)
                            translateY(14%) translateX(10%) !important;
...
.equipmentEditMaster {
  ...
  .equipmentEditMaster .switchEquipmentIn {
    transform: scaleY(1.5) skewY(21deg) rotateY(-180deg) translateY(-30px)
      translateX(11px) !important;
    padding-top: 0px !important;
  }
  .switchEquipmentIn {
    position: absolute !important;
