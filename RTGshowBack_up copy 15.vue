      ...
      <v-dialog v-model="editDriversEquipmentsDialog" max-width="80%" persistent>
        <v-card class="confirmDialogInterface driversInPlanningWithCheckCard">
          ...
          <v-row v-if="selectedChangeEDSow == 1" class="equipmentEditMaster">
            <v-col v-if="getSelected_profile_group.id == 1" cols="11"
              :class="allBothAddButton_switch ? 'speadForEdit' : ''" style="margin: 0 auto">
              <v-row>
                <v-col cols="5" style="
                    margin-bottom: 12px;
                    padding: 0;
            ...
            <v-col v-if="getSelected_profile_group.id == 2" cols="11"
              :class="allBothAddButton_switch ? 'speadForEdit' : ''" style="margin: 0 auto">
              <v-row>
                <v-col cols="5" style="
                    margin-bottom: 12px;
                    ...
                    <v-col cols="12" :style="{
                      ...
                      <v-row class="custom-scrollbar equipmentEdit" style="
                        ...
                        ">
                              ...
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[0] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[0] = !item.equipmentTimesSelected[0]">{{
                                    shift__times[0].split("-")[0] }}<br>{{ shift__times[0].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[1] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[1] = !item.equipmentTimesSelected[1]">{{
                                    shift__times[1].split("-")[0] }}<br>{{ shift__times[1].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[2] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[2] = !item.equipmentTimesSelected[2]">{{
                                    shift__times[2].split("-")[0] }}<br>{{ shift__times[2].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[3] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[3] = !item.equipmentTimesSelected[3]">{{
                                    shift__times[3].split("-")[0] }}<br>{{ shift__times[3].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[4] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[4] = !item.equipmentTimesSelected[4]">{{
                                    shift__times[4].split("-")[0] }}<br>{{ shift__times[4].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[5] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[5] = !item.equipmentTimesSelected[5]">{{
                                    shift__times[5].split("-")[0] }}<br>{{ shift__times[5].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[6] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[6] = !item.equipmentTimesSelected[6]">{{
                                    shift__times[6].split("-")[0] }}<br>{{ shift__times[6].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[7] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[7] = !item.equipmentTimesSelected[7]">{{
                                    shift__times[7].split("-")[0] }}<br>{{ shift__times[7].split("-")[1] }}</span></td>
                              <td><span class="timeClick" :class="item.equipmentTimesSelected[7] ? 'timeClick_ed' : ''"
                                  @click="item.equipmentTimesSelected[7] = !item.equipmentTimesSelected[7]"></span></td>
                            </tr>
                          </tbody>
                        </table>
  ...
  methods: {
    ...
    clickFinish() {
      ...
      if (this.reloadPlanning) {
        ...
        this.tempPlanning_forShow=this.fixItForSTSLogic(this.tempPlanning_forShow,this.ThisOutToBeInserted);
        this.saveDialogShow = true;
      }
    },
    fixItForSTSLogic(temPlanning,ThisOutToBeInserted){
     console.log("temPlanning :",temPlanning);
     console.log("ThisOutToBeInserted :",ThisOutToBeInserted);
    ...
    switchBetweenEquipments() {
      ...
      if (this.getSelected_profile_group?.id == 2) {
