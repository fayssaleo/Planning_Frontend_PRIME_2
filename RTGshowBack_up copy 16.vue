          ...
          <v-row v-if="selectedChangeEDSow == 1" class="equipmentEditMaster">
            <v-col v-if="!whModeSee" cols="11" :class="allBothAddButton_switch ? 'speadForEdit' : ''"
              ...
              <v-row>
                ...
                <v-col cols="5" style="margin-bottom: 12px; padding: 0; min-height: 31px" @click="
                ...
                <v-col cols="11" class="pa-0" style="margin: 0 auto; position: relative;">
                  <span  class="whButtonSeeFeture"
                  @click="whModeSee = !whModeSee" >
                  <div class="cancelEquipment " style=" position:relative ;cursor:pointer !important; height:50px" :class="[
  ...
  methods: {
    ...
    async clickFinish() {
      ...
      if (this.reloadPlanning) {
        ...
        this.fixItForSTSLogic1(equipmentInPlanning_now);
        this.saveDialogShow = true;
      }
    },
        ...
        (e) => {
          ...
          if (this.getSelected_profile_group?.id == 1) {
            ...
            for (let index = 0; index < e.equipmentTimesSelected.length; index++) {
              ...
              console.log("this.getOutToBeInserted[index]", this.getOutToBeInserted[index])
              console.log("e", e)
              console.log("this.getOutToBeInserted[index].list.filter((g)=>g.matricule==e.matricule).length>0", this.getOutToBeInserted[index].list.filter((g) => g.matricule == e.matricule).length > 0)
