                  ...
                  <v-row style="padding: 0 !important" class="equipmentInRow">
                    ...
                    >
                      <span
                        ...
                        "
                      >
                        {{ checkIfEquipmentIsGoingToBrDeleted ? "OUT" : "IN" }}
                      </span>
                      <v-row
                      ...
                      >
                        ...
                        >
                          <span
                            :class="
                              toBeInCmp(item) || toBeOProposedInInCmp(item)
                                ? 'checkForSwitchWith'
                                : ''
                            "
                            class="checkForSwitchThisHide"
                            :style="{
                              backgroundColor: toBeOProposedOutOutCmp(item)
                                ? '#002855 !important'
                                : toBeInCmp(item) || toBeOProposedInInCmp(item)
                                ? '#002855 !important'
                                : '',
                          ...
                          <span
                            ...
                            :class="[
                              ...
                              checkIfEquipmentIsGoingToBrDeleted
                                ...
                                : '',
                              item.checked ? '' : '',
                              toBeOutCmp(item) || toBeOProposedInInCmp(item)
                                ? 'checkForSwitchThis'
                                : '',
                  ...
                  <v-row class="equipmentOutRow">
                    ...
                    >
                      <span
                        ...
                        "
                      >
                        {{ checkIfEquipmentIsGoingToBrDeleted ? "IN" : "OUT" }}
                      </span>
                      <v-row
                        v-if="allBothAddButton_switch"
                        ...
                        <span
                            ...
                            :style="{
                              backgroundColor: toBeOProposedOutOutCmp(item)
                                ? ''
                                : toBeInCmp(item) || toBeOProposedInInCmp(item)
                                ? 'rgba(39, 27, 27, 0.7803921569)  !important'
                                : '',
                            }"
                            >{{
                              toBeInCmp(item) || toBeOProposedInInCmp(item)
                          ...
                          <span
                            ...
                            :class="[
                              ...
                              toBeOutCmp(item) || toBeOProposedInInCmp(item)
                                ? 'checkForSwitchThis'
                                : '',
                              toBeOutAndInCmp(item) ? 'checkForIn' : '',
                            ]"
                            >{{
                              toBeOProposedOutOutCmp(item)
                                ? equipmentEditCheckedForSwitch?.matricule
...
.equipmentEditMaster {
  ...
  .equipmentInRow:hover {
    .switchEquipmentIn {
      background-color: #5c95ff;
    }
  }
  .equipmentOutRow:hover {
    .switchEquipmentIn {
  ...
  .equipmentInRow .switchEquipmentInCheckTag::after {
    content: "\F072E" !important;
    font-family: "Material Design Icons" !important;
    position: absolute !important;
    right: 10% !important;
  ...
  .equipmentOutRow .switchEquipmentInCheckTag::after {
    content: "\F0737" !important;
    font-family: "Material Design Icons" !important;
    position: absolute !important;
    left: 10% !important;
