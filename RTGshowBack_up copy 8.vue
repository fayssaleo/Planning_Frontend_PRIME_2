        ...
        <v-card class="confirmDialogInterface driversInPlanningWithCheckCard">
                ...
                <v-col cols="11" class="pa-0" style="margin: 0 auto">
                  <v-row style="padding: 0 !important" class="equipmentInRow">
                    <v-col cols="12" :style="{
                      ...
                      <span v-if="allBothAddButton_switch" class="equipmentActionController"  >
          ...
          <template v-slot:actions style="width: 100%; /* padding: 0; */ margin-top: 34px">
            ...
            <v-btn density="default" class="nextButton_all" style="background-color: rgb(220 47 2 / 74%)"
              @click="openDeleteDialog" v-if="allBothAddButton_delete">DELETE</v-btn>
            <v-btn density="default" class="nextButton_all" style="background-color: rgb(71 149 52)"
              @click="openAddDriversForSwitch" v-if="allBothAddButton_switch">NEXT</v-btn>
          </template>
        </v-card>
      </v-dialog>
    </div>
  ...
  methods: {
    ...
    addEquipment(){
        ...
        this.equipmentEditActions.push({
          ...
          equipmentEditCheckedForSwitchWith:null,
          index:this.equipmentsNotInPlanningWithCheck.indexOf(this.equipmentEditCheckedForSwitch),
        })
...
.equipmentEditMaster {
  ...
  .equipmentInRow {
    ...
    span:not(.equipmentActionController):not(.do):not(.undo):not(.switchEquipmentIn):not(.checkForSwitchThis):not(.checkForSwitchWith) {
