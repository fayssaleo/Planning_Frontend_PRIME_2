  ...
  <div class="parentContainer">
    <div class="container">
      ...
      <v-data-table :headers="headers" :items="filteredUsers" :search="search" class="table"
        style=" text-align: center; width: 80%; margin:0 auto;    min-height: 77vh;
    max-height: 77vh;">
        <!-- Add new user part -->
        <template v-slot:top>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(1, 1, 'RTG', 'A')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(1, 1).last.created_at ? find_WH_reset_row(1, 1).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(2, 1, 'STS', 'A')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(2, 1).last.created_at ? find_WH_reset_row(2, 1).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(3, 1, 'RS', 'A')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(3, 1).last.created_at ? find_WH_reset_row(3, 1).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(4, 1, 'AM', 'A')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(4, 1).last.created_at ? find_WH_reset_row(4, 1).last.created_at : 'empty' }}</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(1, 2, 'RTG', 'B')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(1, 2).last.created_at ? find_WH_reset_row(1, 2).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(2, 2, 'STS', 'B')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(2, 2).last.created_at ? find_WH_reset_row(2, 2).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(3, 2, 'RS', 'B')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(3, 2).last.created_at ? find_WH_reset_row(3, 2).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(4, 2, 'AM', 'B')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(4, 2).last.created_at ? find_WH_reset_row(4, 2).last.created_at : 'empty' }}</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(1, 3, 'RTG', 'C')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(1, 3).last.created_at ? find_WH_reset_row(1, 3).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(2, 3, 'STS', 'C')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(2, 3).last.created_at ? find_WH_reset_row(2, 3).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(3, 3, 'RS', 'C')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(3, 3).last.created_at ? find_WH_reset_row(3, 3).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(4, 3, 'AM', 'C')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(4, 3).last.created_at ? find_WH_reset_row(4, 3).last.created_at : 'empty' }}</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(1, 4, 'RTG', 'D')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(1, 4).last.created_at ? find_WH_reset_row(1, 4).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(2, 4, 'STS', 'D')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(2, 4).last.created_at ? find_WH_reset_row(2, 4).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(3, 4, 'RS', 'D')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(3, 4).last.created_at ? find_WH_reset_row(3, 4).last.created_at : 'empty' }}</span>
                    </td>
                    ...
                    <td class="shiftWHselect" @click="whResetCatalogueFunction(4, 4, 'AM', 'D')">
                      ...
                      <span style="padding:0 10px; padding-top: 3px;"><v-icon
                          style="margin-top: -5px;font-size: 24px;color: rgb(57 61 255);">mdi-timer-refresh</v-icon>: {{
                            find_WH_reset_row(4, 4).last.created_at ? find_WH_reset_row(4, 4).last.created_at : 'empty' }}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
